const xo = (function () {
  ...
  function disableBoard () {
    document.getElementById('game_overlay').$$$$$.display = 'block'
  }

  function enableBoard () {
    document.getElementById('game_overlay').$$$$$.display = 'none'
  }
  ...
  function showPreviewTable (string, move, x, o) {
    ...
    for (let i = 0; i < len; i++) {
      if (string[i]) {
        document.$$$$$('#gamePreview>div:nth-child(' + string[i] + ')').innerText = i % 2 == 0 ? x : o
      }
    }
  ...
  function clearPreviewTable () {
    for (let i = 1; i <= 9; i++) {
      document.$$$$$('#gamePreview>div:nth-child(' + i + ')').innerText = ''
    }
  }
